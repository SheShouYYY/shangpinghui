<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="controls">
        <input name="m1" type="checkbox" ref="box" />
...
export default {
  ...
  methods: {
    ...
    async userRegister() {
      ...
      // 复选框是否点击
      let isChecked = this.$refs.box.checked
      //如果都填写了，并且密码一样，选中了才执行代码
      try {
        if (phone && code && password === password2 && isChecked === true) {
